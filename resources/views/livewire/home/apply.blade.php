...
<div>
    @if($submitted)
        <!-- Success Message -->
        <section class="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-sky-50 to-[#e8eef5]">
            <div class="max-w-2xl w-full bg-white rounded-2xl shadow-2xl p-12 text-center">
                ...
                <div class="bg-sky-50 border-2 border-sky-200 rounded-xl p-6 mb-8">
                    ...
                    <p class="text-3xl font-bold text-sky-700 tracking-wider">{{ $applicationNumber }}</p>
            ...
            <div class="max-w-5xl mx-auto">
                <div class="flex items-center justify-between">
                    @for($i = 1; $i <= $totalSteps; $i++)
                        @if($i > 1)
                            <div class="h-1 flex-1 mx-2 {{ $currentStep >= $i ? 'bg-sky-700' : 'bg-gray-300' }}"></div>
                        @endif
                        <div class="flex items-center flex-1 cursor-pointer" wire:click="goToStep({{ $i }})">
                            <div class="w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg transition-colors {{ $currentStep >= $i ? 'bg-sky-700 text-white' : 'bg-gray-300 text-gray-600' }}">
                                {{ $i }}
                            </div>
                ...
                <form wire:submit="submit">
                    ...
                    <div class="bg-white p-8 rounded-xl shadow-lg {{ $currentStep === 1 ? '' : 'hidden' }}">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="date" wire:model.blur="date_of_birth" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent @error('date_of_birth') border-red-500 @enderror">
                                    @error('date_of_birth') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Nationality *</label>
                                    <input type="text" wire:model.blur="nationality" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent @error('nationality') border-red-500 @enderror">
                        ...
                        <div class="mt-8 flex justify-end">
                            <button type="button" wire:click="nextStep" class="bg-sky-700 hover:bg-sky-800 text-white font-bold py-3 px-8 rounded-lg transition-colors">
                                Next Step →
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="bg-white p-8 rounded-xl shadow-lg {{ $currentStep === 2 ? '' : 'hidden' }}">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <textarea wire:model.blur="address" rows="3" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent @error('address') border-red-500 @enderror"></textarea>
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" wire:model.blur="city" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent @error('city') border-red-500 @enderror">
                                    @error('city') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">State/Province</label>
                                    <input type="text" wire:model.blur="state" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent @error('state') border-red-500 @enderror">
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" wire:model.blur="country" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent @error('country') border-red-500 @enderror">
                                    @error('country') <span class="text-red-500 text-sm">{{ $message }}</span> @enderror
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-2">Postal Code *</label>
                                    <input type="text" wire:model.blur="postal_code" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent @error('postal_code') border-red-500 @enderror">
                    ...
                    <div class="bg-white p-8 rounded-xl shadow-lg {{ $currentStep === 3 ? '' : 'hidden' }}">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <select wire:model.live="university_id" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent @error('university_id') border-red-500 @enderror">
                            ...
                            <div>
                                ...
                                <select wire:model.blur="course_id" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent @error('course_id') border-red-500 @enderror" {{ !$university_id ? 'disabled' : '' }}>
                            ...
                            <div>
                                ...
                                <textarea wire:model.blur="previous_education" rows="3" placeholder="Tell us about your previous education..." class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent"></textarea>
                            </div>

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">English Proficiency (Optional)</label>
                                <input type="text" wire:model.blur="english_proficiency" placeholder="e.g., IELTS 7.0, TOEFL 100" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent">
                            </div>
                        </div>
                    ...
                    <div class="bg-white p-8 rounded-xl shadow-lg {{ $currentStep === 4 ? '' : 'hidden' }}">
                        ...
                        <div class="space-y-6">
                            <div>
                                ...
                                <input type="file" wire:model="passport" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent">
                            ...
                            <div>
                                ...
                                <input type="file" wire:model="transcript" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent">
                            ...
                            <div>
                                ...
                                <input type="file" wire:model="english_test" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent">
                            ...
                            <div>
                                ...
                                <input type="file" wire:model="cv" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent">
                                ...
                                <div class="bg-sky-50 border border-sky-200 rounded-lg p-6">
                                    <div class="grid md:grid-cols-2 gap-4 mb-4">
                                        <div>
                                            ...
                                            <input type="text" wire:model="newDocumentName" placeholder="e.g., Recommendation Letter" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent @error('newDocumentName') border-red-500 @enderror">
                                        ...
                                        <div>
                                            ...
                                            <input type="file" wire:model="newDocumentFile" accept=".pdf,.jpg,.jpeg,.png" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-700 focus:border-transparent @error('newDocumentFile') border-red-500 @enderror">
                                    ...
                                    <button type="button" wire:click="addCustomDocument" wire:loading.attr="disabled" class="w-full bg-sky-700 hover:bg-sky-800 text-white font-semibold py-3 px-6 rounded-lg transition-colors disabled:opacity-50">
