        ...
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div class="flex items-center gap-x-3">
                <button
                    ...
                    role="switch"
                    aria-checked="{{ $whatsapp_enabled ? 'true' : 'false' }}"
                >
                    <span @class([
                ...
                <span class="text-sm text-gray-500 dark:text-gray-400">
                    (Show or hide the floating button on the website)
                </span>
            </div>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input
                        ...
                        class="block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-950 shadow-sm transition duration-75 placeholder:text-gray-400 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 dark:border-white/20 dark:bg-white/5 dark:text-white"
                    />
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">International format, no + or spaces — e.g. 2348012345678</p>
                ...
                <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Where the button floats on the screen</p>
                </div>
            </div>
            ...
            <div>
                ...
                <textarea
                    ...
                    class="block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-950 shadow-sm placeholder:text-gray-400 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 dark:border-white/20 dark:bg-white/5 dark:text-white"
                ></textarea>
                <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">This message is pre-filled when a visitor opens WhatsApp</p>
